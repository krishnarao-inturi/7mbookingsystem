...
var vec__9398_9401 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_9402 = cljs.core.nth.call(null,vec__9398_9401,(0),null);
var only_after_9403 = cljs.core.nth.call(null,vec__9398_9401,(1),null);
var db_changed_QMARK__9404 = (cljs.core.some_QMARK_.call(null,only_before_9402)) || (cljs.core.some_QMARK_.call(null,only_after_9403));
if(db_changed_QMARK__9404){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for: ",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before: ",only_before_9402);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after : ",only_after_9403);
...
var map__9411 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__9411__$1 = ((((!((map__9411 == null)))?((((map__9411.cljs$lang$protocol_mask$partition0$ & (64))) || (map__9411.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9411):map__9411);
var db = cljs.core.get.call(null,map__9411__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__9411__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__9419 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__9419__$1 = ((((!((map__9419 == null)))?((((map__9419.cljs$lang$protocol_mask$partition0$ & (64))) || (map__9419.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9419):map__9419);
var coeffects = map__9419__$1;
var event = cljs.core.get.call(null,map__9419__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__6677__auto___9422 = arguments.length;
var i__6678__auto___9423 = (0);
while(true){
if((i__6678__auto___9423 < len__6677__auto___9422)){
args__6684__auto__.push((arguments[i__6678__auto___9423]));

var G__9424 = (i__6678__auto___9423 + (1));
i__6678__auto___9423 = G__9424;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__6685__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq9421){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq9421));
});
...
var args__6684__auto__ = [];
var len__6677__auto___9430 = arguments.length;
var i__6678__auto___9431 = (0);
while(true){
if((i__6678__auto___9431 < len__6677__auto___9430)){
args__6684__auto__.push((arguments[i__6678__auto___9431]));

var G__9432 = (i__6678__auto___9431 + (1));
i__6678__auto___9431 = G__9432;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__6685__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__9425_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__9426_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__9426_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq9427){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__9428,G__9429,seq9427__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1483597754260