...
var m__6266__auto__ = (alandipert.storage_atom._get[goog.typeOf(x__6265__auto__)]);
if(!((m__6266__auto__ == null))){
return m__6266__auto__.call(null,this$,not_found);
} else {
var m__6266__auto____$1 = (alandipert.storage_atom._get["_"]);
if(!((m__6266__auto____$1 == null))){
return m__6266__auto____$1.call(null,this$,not_found);
} else {
...
var x__6265__auto__ = (((this$ == null))?null:this$);
var m__6266__auto__ = (alandipert.storage_atom._commit_BANG_[goog.typeOf(x__6265__auto__)]);
if(!((m__6266__auto__ == null))){
return m__6266__auto__.call(null,this$,value);
} else {
var m__6266__auto____$1 = (alandipert.storage_atom._commit_BANG_["_"]);
if(!((m__6266__auto____$1 == null))){
return m__6266__auto____$1.call(null,this$,value);
} else {
...
alandipert.storage_atom.StorageBackend.cljs$lang$ctorPrWriter = (function (this__6208__auto__,writer__6209__auto__,opt__6210__auto__){
return cljs.core._write.call(null,writer__6209__auto__,"alandipert.storage-atom/StorageBackend");
});
...
var G__9207 = atom;
cljs.core.add_watch.call(null,G__9207,new cljs.core.Keyword("alandipert.storage-atom","storage-watch","alandipert.storage-atom/storage-watch",1159565749),((function (G__9207,existing,debounce){
return (function (p1__9204_SHARP_,p2__9205_SHARP_,p3__9202_SHARP_,p4__9203_SHARP_){
if(cljs.core.truth_((function (){var and__5590__auto__ = alandipert.storage_atom._STAR_watch_active_STAR_;
if(cljs.core.truth_(and__5590__auto__)){
return cljs.core.not_EQ_.call(null,p3__9202_SHARP_,p4__9203_SHARP_);
} else {
return and__5590__auto__;
}
})())){
return debounce.call(null,((function (G__9207,existing,debounce){
return (function (){
return alandipert.storage_atom._commit_BANG_.call(null,backend,p4__9203_SHARP_);
});})(G__9207,existing,debounce))
,(function (){var or__5602__auto__ = alandipert.storage_atom._STAR_storage_delay_STAR_;
...
var _STAR_watch_active_STAR_9210 = alandipert.storage_atom._STAR_watch_active_STAR_;
alandipert.storage_atom._STAR_watch_active_STAR_ = false;

try{return cljs.core.reset_BANG_.call(null,atom,default$);
}finally {alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR_9210;
}} else {
...
var _STAR_watch_active_STAR_9211 = alandipert.storage_atom._STAR_watch_active_STAR_;
alandipert.storage_atom._STAR_watch_active_STAR_ = false;
...
}finally {alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR_9211;
}} else {
return null;
}
} else {
...
return alandipert.storage_atom.maybe_update_backend.call(null,atom,storage,k,default$,p1__9212_SHARP_);
});})(default$))
);
});
/**
...
//# sourceMappingURL=storage_atom.js.map?rel=1483597753844